...
- Per ora raccogli i dati e conferma a voce.
...
`,
    ...
    openaiWs.send(
      JSON.stringify({
        ...
        response: {
          ...
          instructions:
            "Saluta il cliente e chiedi come puoi aiutarlo con una prenotazione al Ristorante Pizzeria Trevisago.",
        },
      })
    );
  });
  ...
  openaiWs.on("message", (message) => {
    try {
      ...
      console.error("Errore parse OpenAI:", err);
    }
  });
